...
<body>
			...
			<form action="index.php?tp=zongzi&action=query&act=select"
				...
				<ul>
					<li><input type="text" name="tqm" class="keywords"
						required="required" value="<?php echo  $_GET['out_trade_no']!=""?$_GET['out_trade_no']:"";?>" placeholder="输入订单号或联系QQ" /></li>
					<li><input type="image"
	...
	<div style="min-height: 50px;text-align: center; background-color: black;color:white;line-height: 50px;"> 2017 &copy;  <?php echo $conf['title'];?></div>
