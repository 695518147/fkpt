...
<div class="panel panel-info" style="float: none;">
	...
	<ul class="list-group">
		...
		<li class="list-group-item">
			<b>当前版本：</b><span id="up"><?php  echo VERSION;?>　<a href="./info.php?act=updateinfo" style="color:green;">检测更新</a></span>
		</li>
			    ...
			    <?php 
			         if(empty($conf['epay_id']) ||$conf['epay_key'] == ""){
			             ...
			             if(empty($arr['account']) || $arr['account'] == null){
			                 ...
			                 echo "<font style='color:red;'>欢迎使用个人发卡平台程序，客服QQ：781061178 & 2313704  ！售后群：695518147！请使用正版程序！</font>";
			             }
			         }else{
			             echo "<font style='color:red;'>欢迎使用个人发卡平台程序! 请务必添加售后群：695518147！</font>";
			         }
			     ?>
