	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" id="view" name="view">
				<option value="default" <?php if($conf['view']=="default") echo "selected"; ?> >发卡程序默认模板 </option>
				<option value="ocean" <?php if($conf['view']=="ocean") echo "selected"; ?> >海洋版  4.0特别版</option>
				<option value="zongzi" <?php if($conf['view']=="zongzi") echo "selected"; ?> > 远走的粽子 </option>
						</select>
		</div>
	</div>
